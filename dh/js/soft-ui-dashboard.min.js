...
function sidebarColor(e) {
    ...
    e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active"), document.querySelector(".sidenav").setAttribute("data-color", a);
    var i = document.querySelector("#sidenavCard"),
        e = ["card", "card-background", "shadow-none", "card-background-mask-" + a];
    i.className = "", i.classList.add(...e);
    e = document.querySelector("#sidenavCardIcon"), a = ["ni", "ni-diamond", "text-gradient", "text-lg", "top-0", "text-" + a];
    e.className = "", e.classList.add(...a)
}

function sidebarType(e) {
    for (var t = e.parentElement.children, a = e.getAttribute("data-class"), n = 0; n < t.length; n++) t[n].classList.remove("active");
    e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active");
    e = document.querySelector(".sidenav");
    e.classList.remove("bg-transparent"), e.classList.remove("bg-white"), e.classList.add(a)
}
...
function navbarBlurOnScroll(e) {
    ...
    function i() {
        t.classList.remove(...a), t.classList.add(...n), l("transparent")
    }
    ...
    window.onscroll = debounce("true" == e ? function () {
        5 < window.scrollY ? (t.classList.add(...a), t.classList.remove(...n), l("blur")) : i()
    } : function () {
        i()
    }, 10)
}
            ...
            if (i) {
                ...
                l.querySelector("li:nth-child(" + n + ") .nav-link").onclick = function () {
                    ...
                    if (l.classList.contains("flex-column")) {
                        ...
                        o.style.transform = "translate3d(" + e + "px, 0px, 0px)", o.style.width = l.querySelector("li:nth-child(" + n + ")").offsetWidth + "px"
                    }
                }
            }
        }
    ...
    total.forEach(function (a, e) {
        ...
        if (l) {
            ...
            if (a.classList.contains("flex-column")) {
                for (var o = 1; o <= e.indexOf(l); o++) t += a.querySelector("li:nth-child(" + o + ")").offsetHeight;
                n.style.transform = "translate3d(0px," + t + "px, 0px)", n.style.width = a.querySelector("li:nth-child(" + i + ")").offsetWidth + "px", n.style.height = a.querySelector("li:nth-child(" + o + ")").offsetHeight
            } else {
                for (o = 1; o <= e.indexOf(l); o++) t += a.querySelector("li:nth-child(" + o + ")").offsetWidth;
